 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Min Kyung Jo");
		  toPrint += p1.toString("mjo30");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Soyeon Lee");
		  toPrint += p2.toString("slee608");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Eun Bin Lee");
		  toPrint += p3.toString("elee358");
